...
public class AdvancedSmelterRecipe extends RecipeBuilder<AdvancedSmelterRecipe> implements ISmelterRecipe {
    ...
    public AdvancedSmelterRecipe(ResourceLocation id, ItemStack output, NonNullList<Ingredient> inputs, int powerCost) {
        this(id, output, inputs, powerCost, Configs.ADVANCED_SMELTER_RF_RATE.get());
    }

    public AdvancedSmelterRecipe(ResourceLocation id, ItemStack output, NonNullList<Ingredient> inputs, int powerCost, int powerRate) {
        super(new ResourceLocation(AtomicTechnology.MOD_ID, "advanced_smelter"));
    ...
    public ResourceLocation getRecipeLocation() {
        return new ResourceLocation(AtomicTechnology.MOD_ID, "advanced_smelter");
    }

    @Override
    public IRecipeSerializer<?> getSerializer() {
        return AtomicRecipeSerializers.ADVANCED_SMELTER;
    }

    @Override
    public IRecipeType<?> getType() {
        return AtomicRecipeTypes.ADVANCED_SMELTER;
    }
    ...
    public static class Serializer extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<AdvancedSmelterRecipe> {
        @Override
        public AdvancedSmelterRecipe read(ResourceLocation recipeId, JsonObject json) {
            ...
            return new AdvancedSmelterRecipe(recipeId, output, inputs, powerCost, powerRate);
        }

        @Override
        public AdvancedSmelterRecipe read(ResourceLocation recipeId, PacketBuffer buffer) {
            NonNullList<Ingredient> inputs = NonNullList.create();
        ...
        @Override
        public void write(PacketBuffer buffer, AdvancedSmelterRecipe recipe) {

...
public class EliteSmelterRecipe extends RecipeBuilder<EliteSmelterRecipe> implements ISmelterRecipe {
    ...
    public EliteSmelterRecipe(ResourceLocation id, ItemStack output, NonNullList<Ingredient> inputs, int powerCost) {
        this(id, output, inputs, powerCost, Configs.ELITE_SMELTER_RF_RATE.get());
    }

    public EliteSmelterRecipe(ResourceLocation id, ItemStack output, NonNullList<Ingredient> inputs, int powerCost, int powerRate) {
        super(new ResourceLocation(AtomicTechnology.MOD_ID, "elite_smelter"));
    ...
    public ResourceLocation getRecipeLocation() {
        return new ResourceLocation(AtomicTechnology.MOD_ID, "elite_smelter");
    }

    @Override
    public IRecipeSerializer<?> getSerializer() {
        return AtomicRecipeSerializers.ELITE_SMELTER;
    }

    @Override
    public IRecipeType<?> getType() {
        return AtomicRecipeTypes.ELITE_SMELTER;
    }
    ...
    public static class Serializer extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<EliteSmelterRecipe> {
        @Override
        public EliteSmelterRecipe read(ResourceLocation recipeId, JsonObject json) {
            ...
            return new EliteSmelterRecipe(recipeId, output, inputs, powerCost, powerRate);
        }

        @Override
        public EliteSmelterRecipe read(ResourceLocation recipeId, PacketBuffer buffer) {
            NonNullList<Ingredient> inputs = NonNullList.create();
        ...
        @Override
        public void write(PacketBuffer buffer, EliteSmelterRecipe recipe) {

...
public class BasicSmelterTile extends AbstractSmelterTile<BasicSmelterRecipe> {
    public BasicSmelterTile() {
        super(AtomicTiles.BASIC_SMELTER.get(), Configs.BASIC_SMELTER_RF_CAPACITY.get());
    }
    ...
    public void tick() {
        ...
        if (world != null) {
            ...
            if (this.recipe == null || !this.recipe.matches(recipeInventory, world))
                this.recipe = world.getRecipeManager().getRecipe(AtomicRecipeTypes.BASIC_SMELTER, recipeInventory, world).orElse(null);
    ...
    public ITextComponent getDisplayName() {
        return Localizable.of("containers.atomictechnology.basic_smelter").build();
    }

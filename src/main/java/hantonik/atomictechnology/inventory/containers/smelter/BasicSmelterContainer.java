...
public class BasicSmelterContainer extends Container {
    ...
    public static BasicSmelterContainer create(int windowId, PlayerInventory playerInventory, PacketBuffer buffer) {
        return new BasicSmelterContainer(AtomicContainers.BASIC_SMELTER.get(), windowId, playerInventory, buffer);
    }
    ...
    public static BasicSmelterContainer create(int windowId, PlayerInventory playerInventory, Function<PlayerEntity, Boolean> isUsableByPlayer, BasicItemStackHandler inventory, IIntArray data, BlockPos pos) {
        return new BasicSmelterContainer(AtomicContainers.BASIC_SMELTER.get(), windowId, playerInventory, isUsableByPlayer, inventory, data, pos);
    }

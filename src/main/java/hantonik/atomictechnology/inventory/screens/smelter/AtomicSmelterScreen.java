...
public class AtomicSmelterScreen  extends BasicContainerScreen<AtomicSmelterContainer> {
    ...
    public AtomicSmelterScreen(AtomicSmelterContainer container, PlayerInventory inventory, ITextComponent title) {
    ...
    public void render(MatrixStack stack, int mouseX, int mouseY, float partialTicks) {
        ...
        AtomicSmelterContainer container = this.getContainer();

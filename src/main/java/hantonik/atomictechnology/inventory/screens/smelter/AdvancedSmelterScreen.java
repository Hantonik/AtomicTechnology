...
public class AdvancedSmelterScreen  extends BasicContainerScreen<AdvancedSmelterContainer> {
    ...
    public AdvancedSmelterScreen(AdvancedSmelterContainer container, PlayerInventory inventory, ITextComponent title) {
    ...
    public void render(MatrixStack stack, int mouseX, int mouseY, float partialTicks) {
        ...
        AdvancedSmelterContainer container = this.getContainer();
